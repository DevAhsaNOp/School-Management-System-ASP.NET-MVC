...
public partial class EmployeeResumeTable
{
    ...
    public virtual EmployeeResumeTable EmployeeResumeTable1 { get; set; }

    public virtual EmployeeResumeTable EmployeeResumeTable2 { get; set; }

    public virtual EmployeeResumeTable EmployeeResumeTable11 { get; set; }

    public virtual EmployeeResumeTable EmployeeResumeTable3 { get; set; }
